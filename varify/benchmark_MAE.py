...
if __name__=="__main__":
    mod='Sample7'
    for j in os.listdir('./essay/varify/displace'+mod):
        path_0='./essay/varify/displace'+mod
        mode=j
        ...
        for i in os.listdir(path):
            if 'csv' in i and [j for j in i if str.isdigit(j)]!=[]:
                ...
                num=int(num_list)
                #print(num)
                b,m,s,a,v=benchmark(num*.1,path1)######    num 前面的取和位移同号
                dict[num]=(b,m,s,a,v,num*0.1-a)######    num 前面的取和位移同号
                print(i)
